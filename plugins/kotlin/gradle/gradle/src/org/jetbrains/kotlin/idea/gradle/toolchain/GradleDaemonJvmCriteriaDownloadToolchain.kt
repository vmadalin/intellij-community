...
object GradleDaemonJvmCriteriaDownloadToolchain {
    ...
    private fun JdkItem.matchesKnownVendor(vendor: String?) =
        tryParseToKnownVendors(vendor)?.toDefaultLowerCase()?.startsWith(product.vendor.toDefaultLowerCase()) ?: false
